...
class SalFormer(torch.nn.Module):
    def __init__(self, vision_encoder, bert):
        ...
        self.text_positional_embedding = torch.nn.Parameter(torch.zeros(15, self.feature_dim))
    ...
    def forward(self, img, q_inputs):
        ...
        out = torch.reshape(latent_features, (latent_features.shape[0], self.feature_dim, 8, 8))
