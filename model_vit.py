...
class SalFormer(torch.nn.Module):
    def __init__(self, vision_encoder, bert):
        ...
        self.self_attetion1 = torch.nn.MultiheadAttention(self.feature_dim, 16, batch_first=True)
    ...
    def forward(self, img, q_inputs):
        ...
        img_features =  self.vit.forward(img, return_dict =True)["last_hidden_state"][:,1:,:]
